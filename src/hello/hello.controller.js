...
var HelloController = /** @class */ (function () {
    ...
    HelloController.prototype.sayWelcome = function (personDto) {
        return __awaiter(this, void 0, void 0, function () {
            var msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.helloService.welcome(personDto)];
                    case 1:
                        msg = _a.sent();
    ...
    HelloController.prototype.sayWelcome2 = function (iName, iYear) {
        return __awaiter(this, void 0, void 0, function () {
            var msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.helloService.welcome({
                            name: iName, year: iYear
                        })];
                    case 1:
                        msg = _a.sent();
                        return [2 /*return*/, { data: msg }];
    ...
    ], HelloController.prototype, "sayWelcome");
    __decorate([
    ...
    ], HelloController.prototype, "sayWelcome2");
